export const SearchPage = ({ domain, apiKey, pageSize = 50, perPage = 5 }) => {
  ...
  const MOCK = [
    ...
    { path: "/guide/admin/20057981460761", content: "ロール：「システム管理者」「マネージャー」", metadata: { title: "ユーザー管理" } },
    ...
    { path: "/features/advanced/31681875230617", content: "**ロールごと**に設定できる新規機能となります。", metadata: { title: "電話番号下4桁マスク表示・電話番号編集制限機能" } },
    ...
    { path: "/features/advanced/33006613337369", content: "初期の6つのロールに加え、権限をカスタムし新たにロールを作成できる新機能となります。", metadata: { title: "カスタムロール機能の作成・削除方法" } },
    { path: "/features/advanced/12790321037081", content: "登録してあるユーザーを、オフィスやユニットごとに管理することができます。", metadata: { title: "オフィス・ユニット作成" } },
    { path: "/features/advanced/33020535814553", content: "こちらの記事でご説明した作成したカスタムロールを、実際のユーザーに適用する方法をご説明します。", metadata: { title: "作成したカスタムロールをユーザーへの適用方法" } },
    ...
    { path: "/features/advanced/12777051460249", content: "Comdesk Leadでのロールについてご説明します。", metadata: { title: "ロールについて" } },
