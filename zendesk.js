...
(function () {
  ...
  style.textContent = [
    ...
    "div[id*='assistant-bar'],div[class*='assistant-bar'],div[class*='AssistantBar'],div[data-component*='assistant']{bottom:12px!important;max-height:calc(100vh - 36px)!important;overflow-y:auto!important;box-shadow:0 8px 24px rgba(0,0,0,.18),0 2px 6px rgba(0,0,0,.08)!important;border-radius:14px!important}",
    "button[aria-label*='Ask AI' i],button[title*='Ask AI' i]{box-shadow:0 4px 14px rgba(0,188,212,.35)!important}",
    '.mintlify-assistant-bar,.mintlify-assistant,.assistant-bar{position:fixed!important;bottom:12px!important;left:50%!important;transform:translateX(-50%)!important;max-height:calc(100vh - 36px)!important;overflow-y:auto!important;box-shadow:0 10px 28px rgba(0,0,0,.18),0 2px 6px rgba(0,0,0,.08)!important;border-radius:16px!important;background:#fff!important;border:1px solid #e6f6f9!important;z-index:9990!important;transition:box-shadow .2s,transform .15s}',
    '.mintlify-assistant-bar:hover,.mintlify-assistant:hover,.assistant-bar:hover{box-shadow:0 12px 32px rgba(0,188,212,.25),0 3px 8px rgba(0,0,0,.08)!important;transform:translateX(-50%) translateY(-1px)!important}'
  ].join('');
